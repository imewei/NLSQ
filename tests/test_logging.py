...
class TestNLSQLogger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original_env = {}
        for key in ['NLSQ_DEBUG', 'NLSQ_VERBOSE', 'NLSQ_TRACE_JAX', 'NLSQ_SAVE_ITERATIONS', 'NLSQ_LOG_DIR']:
    ...
    def test_log_levels(self):
        ...
        logger = NLSQLogger('level_test', level=LogLevel.DEBUG)
    ...
    def test_timer_context_manager(self):
        ...
        self.assertLess(logger.timers['test_operation'], 0.1)  # Should be less than 100ms
