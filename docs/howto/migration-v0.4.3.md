# Migration Guide: v0.4.2 to v0.4.3

This guide helps you migrate your NLSQ code from v0.4.2 to v0.4.3. The v0.4.3 release includes
...
v0.4.3 introduces factory functions for runtime configuration of optimizers:
...
v0.4.3 validates custom model files loaded via CLI before execution. Models containing
...
v0.4.3 provides a `wait_for()` utility for reliable condition waiting:
...
**None.** v0.4.3 is fully backward compatible with v0.4.2.
